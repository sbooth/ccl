...
avl's implementation of binary search trees for backend storage.

Please send bug reports, suggestions and comments to <me@sbooth.org>

Visit ccl on the web at https://sbooth.org/ccl/
